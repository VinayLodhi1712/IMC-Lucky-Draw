...
function WaterWinnersPage() {
  ...
  const downloadExcel = async () => {
    ...
    try {
      ...
      a.href = url
      a.download = "water-winners-report.xlsx"
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-orange-50">
      ...
      <AnimatePresence mode="wait">
        {currentView === "dashboard" ? (
          <DashboardView
            key="dashboard"
            title="Water Tax Lucky Draw Portal"
            subtitle="Select a prize category to initiate the automated lucky draw for eligible water taxpayers"
            prizes={prizeData}
